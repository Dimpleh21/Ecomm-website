...
const CreateUpdateCat = dynamic(() => import("./CreateUpdateCat"), {
  ssr: false,
});
...
export const columns = [
  ...
  },
  {
    ...
    header: "Actions",
    cell: ({ row }) => {
      // Log the entire row and id to debug

      return (
        <div className="flex gap-2">
          <CreateUpdateCat category={row?.original}>Update</CreateUpdateCat>
          <DeleteButton
            id={row?.original?._id || "defaultId"} // Provide a fallback id if necessary
            table="category"
          >
            Delete
          </DeleteButton>
